...
from deepgen_rl.sft.datasets.utils import crop2square, resize_image_fix_pixels, resize_image_dynamic
...
class CaptionDataset(Dataset):
    def __init__(self,
                 ...
                 unconditional=0.1,
                 sample_weight=1.0,  # Sampling weight for weighted sampler
                 ):
        super().__init__()
        self.data_path = data_path
        self.sample_weight = sample_weight  # Store for WeightedInfiniteSampler
